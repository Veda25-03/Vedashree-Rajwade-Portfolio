...
import { 
  FaHome, FaUsers, FaCalendarAlt, FaChartLine, FaHistory, 
  FaHospital, FaUserMd, FaFlask, FaChevronLeft, FaChevronRight,
  FaHeartbeat
} from 'react-icons/fa';
...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const menuItems = [
    ...
    { icon: FaUsers, label: 'Donors', path: '/dashboard/donors' },
    { icon: FaCalendarAlt, label: 'Appointments', path: '/dashboard/appointments' },
    { icon: MdBloodtype, label: 'Blood Components', path: '/dashboard/components' },
    { icon: FaHospital, label: 'Hospital Requests', path: '/dashboard/hospitals' },
    { icon: FaUserMd, label: 'Doctors', path: '/dashboard/doctors' },
    ...
    <div className={`bg-white shadow-lg transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'} min-h-screen relative`}>
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center">
          ...
          {!isCollapsed && (
            <div className="ml-3">
              <h1 className="text-xl font-bold text-gray-900">JIVAN BBMS</h1>
